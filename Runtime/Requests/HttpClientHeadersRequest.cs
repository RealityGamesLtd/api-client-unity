...
{
    public class HttpClientHeadersRequest : IHttpRequest
    {
        ...
        private readonly Func<HttpClientHeadersRequest> _recreateFunc;
        ...
        public HttpClientHeadersRequest(
            ...
            Func<HttpClientHeadersRequest> recreateFunc)
        {
